  ...
  try {
      ...
      const result = await pool.query(
        ...
        [
            ...
            source,
            timestamp,
            parseFloat(priority ?? 0).toFixed(2),
            cause,
            parseFloat(causeValue ?? 0).toFixed(2),
            effect,
            effectValue,
        ]
      );
  ...
  try {
      ...
      const result = await pool.query(
        ...
        [
            ...
            parseFloat(energiaReativa ?? 0).toFixed(2),
            parseFloat(energiaAparente ?? 0).toFixed(2),
            parseFloat(energiaInjetada ?? 0).toFixed(2),
            parseFloat(demandaAtiva ?? 0).toFixed(2),
            parseFloat(demandaReativa ?? 0).toFixed(2),
            parseFloat(demandaAparente ?? 0).toFixed(2),
            alarmes,
            naoConformidade,
            getId.rows[0].id,
        ]
