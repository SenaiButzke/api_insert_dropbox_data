  ...
  try {
      ...
      const result = await pool.query(
        ...
        [
            pmeId,
            dataImportacao,
            Number(tensaoEletrica.toFixed(2)),
            Number(correnteEletrica.toFixed(2)),
            Number(frequencia.toFixed(2)),
            Number(fatorPotencia.toFixed(2)),
            Number(harmonicas.toFixed(2)),
            Number(energiaAtiva.toFixed(2)),
            Number(energiaReativa.toFixed(2)),
            Number(energiaAparente.toFixed(2)),
            Number(energiaInjetada.toFixed(2)),
            Number(demandaAtiva.toFixed(2)),
            Number(demandaReativa.toFixed(2)),
            Number(demandaAparente.toFixed(2)),
            alarmes,
            naoConformidade,
            getId.rows[0].id,
        ]
